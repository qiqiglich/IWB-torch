...
def resnet56(num_classes=100, use_norm=False, return_features=False):
    return ResNet_s(BasicBlock, [9, 9, 9], num_classes=num_classes, use_norm=use_norm, return_features=return_features)
